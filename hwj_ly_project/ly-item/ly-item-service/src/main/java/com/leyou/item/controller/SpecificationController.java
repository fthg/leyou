...
public class SpecificationController {
    ...
    public ResponseEntity<List<SpecGroup>> querySpecGroups(@PathVariable("cid") Long cid){
       List <SpecGroup> groups=this.specService.querySpecGroupByCid(cid);
    ...
    public ResponseEntity<List<SpecParam>> querySpecParamList(
        ...
        List<SpecParam> params = specService.querySpecParamList(gid, cid,generic,searching);
...
//    }
     ...
     */
    @PostMapping("group")
    public ResponseEntity<Void> saveSpecification(){
        this.specService.saveSpecification();
    ...
    public ResponseEntity<Void> deleteSpecification(@PathVariable("id") Long id){
        ...
        this.specService.deleteSpecification();
        return ResponseEntity.status(HttpStatus.OK).build();
    }
